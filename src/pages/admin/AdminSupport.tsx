...
import { Send, MessageSquare, CheckCircle2, User, Pencil, X, Check } from "lucide-react";
                ...
                <CardContent className="flex-1 overflow-y-auto p-4 space-y-3">
                  {messages.map((msg) => (
                    <div key={msg.id} className={`flex ${msg.sender_type === "admin" ? "justify-end" : "justify-start"}`}>
                      <div className={`max-w-[80%] rounded-xl px-4 py-2.5 text-sm group relative ${
                        ...
                        {editingMessageId === msg.id ? (
                          <div className="space-y-2 min-w-[260px]">
                            <Textarea
                              ...
                              className="text-sm bg-background text-foreground border-0 focus-visible:ring-1 resize-none min-h-[80px]"
                              onKeyDown={(e) => {
                            ...
                            <div className="flex gap-1.5 justify-end">
                              <Button size="icon" variant="ghost" className="h-6 w-6 opacity-80 hover:opacity-100" onClick={cancelEdit}>
                                <X className="w-3.5 h-3.5" />
                              </Button>
                              <Button size="icon" variant="ghost" className="h-6 w-6 opacity-80 hover:opacity-100" onClick={() => saveEdit(msg.id)}>
                            ...
                            <div className="flex items-center gap-1.5 mt-0.5">
                              ...
                              {msg.sender_type === "admin" && (
                                <button
                                  ...
                                  className="text-[9px] opacity-0 group-hover:opacity-50 hover:!opacity-100 transition-opacity flex items-center gap-0.5"
                                >
