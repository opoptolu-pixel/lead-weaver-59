-- Update the is_lead_access_expired function to use 90 days
...
AS $$
  SELECT COALESCE(unlocked_at_param, now()) < (now() - INTERVAL '90 days')
$$;

-- Update the get_user_leads_with_access_control function to use 90 days
