...
CREATE TABLE IF NOT EXISTS public.cleaner_job_notifications (
  ...
  notification_type text NOT NULL CHECK (notification_type IN ('offer_email','assigned_email','reminder_3_day_email','reminder_1_day_email','reminder_day_email','reminder_day_sms')),
