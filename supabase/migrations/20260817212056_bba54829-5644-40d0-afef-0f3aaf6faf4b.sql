...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.cleaner_vetting_records TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.cleaner_vetting_documents TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.cleaner_compliance_reminders TO authenticated;
GRANT ALL ON public.cleaner_vetting_records TO service_role;
GRANT ALL ON public.cleaner_vetting_documents TO service_role;
GRANT ALL ON public.cleaner_compliance_reminders TO service_role;
...
$$;
REVOKE ALL ON FUNCTION public.cleaner_vetting_ready(uuid) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.cleaner_vetting_ready(uuid) TO authenticated, service_role;
