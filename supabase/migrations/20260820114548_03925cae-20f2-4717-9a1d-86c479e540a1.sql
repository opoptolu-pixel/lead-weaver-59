...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.recurring_clean_plan_addons TO authenticated;
GRANT ALL ON public.recurring_clean_plan_addons TO service_role;
