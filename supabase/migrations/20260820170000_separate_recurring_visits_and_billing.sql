-- A recurring clean has two independent rhythms:
--   * attendance frequency controls cleaner visits/jobs
--   * billing frequency controls when the customer is charged
-- Existing plans retain their current behaviour until an admin changes them.
